let blogs = {
  read: [
    ...
    },
    {
      ...
      description:
        "Talks about building scalable and centralized authorization system",
      authors: "Alan Yao, Dipak Pawar & others",
      image:
    ...
    },
    {
      ...
      description:
        "Talks about how carta built an authorization system based on Google Zanzibar",
      authors: "Aaron Tainter",
      image:
  ...
  written: [
    {
      name: "Introduction to Observability and Distributed Tracing using Jaeger",
      description: "Observability and Distributed Tracing Using Jaeger",
    ...
    },
    {
      ...
      description: "Provisioning infra on AWS using Terraform",
      authors: "Ankush Chavan",
      image:
    ...
    },
    {
      ...
      description:
        "Provisioning infra on AWS using Terraform with the help of Ansible and Jenkins",
      authors: "Ankush Chavan",
